...
public class ProfileActivityFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cropActivity = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            ...
            public void onActivityResult(ActivityResult result) {
                ...
                if (result.getResultCode() == RESULT_OK) {
                    ...
                    Picasso.with(ProfileActivityFaculty.this).load(resultUri).into(profilePicture);
        ...
        mBase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!url.equals(""))
                    Picasso.with(ProfileActivityFaculty.this).load(url).into(profilePicture);
                    ...
                    storageRef.child(uid+".png").getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                dialog.dismiss();
                                Picasso.with(ProfileActivityFaculty.this).load(imageuri).into(profilePicture);
